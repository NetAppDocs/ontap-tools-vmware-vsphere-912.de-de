...
* Wenn Sie eine virtuelle Maschine so konfigurieren, dass die Replikation für vorhandene Datastores aktiviert wird, stellen Sie sicher, dass das FlexVol-Volume mit konfigurierenden VVols überprüft wird.
