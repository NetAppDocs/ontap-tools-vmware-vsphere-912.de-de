...
+
Siehe link:..configure/task_configure_user_role_and_privileges.html["Konfigurieren von Benutzerrollen und -Berechtigungen"]
 Abschnitt in der Dokumentation _ONTAP Tools for VMware vSphere_.
