...
Die ONTAP-Tools für VMware vSphere 9.12 Version entfernt frühere 2.0 Syslog-APIs und enthält neue 3.0 Syslog-bezogene APIs, die gegenseitige Authentifizierung unterstützen.
