...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/7-0/vsphere-availability/creating-and-using-vsphere-ha-clusters.html["VMware vSphere Dokumentation: Erstellen und Verwenden von vSphere HA-Clustern"^]
